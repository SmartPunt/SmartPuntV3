  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(251,191,36,0.10),transparent_20%),linear-gradient(180deg,#111315_0%,#18181b_50%,#0f172a_100%)] text-white">
      <div className="mx-auto max-w-7xl px-4 py-6 lg:px-8 lg:py-8">
        <div className="relative overflow-hidden rounded-[32px] bg-black shadow-xl border border-white/10 min-h-[180px]">
          <img
            src="/header-logo.png"
            alt="Fortune on 5"
            className="absolute left-1/2 top-[45%] w-[260px] max-w-none -translate-x-1/2 -translate-y-1/2 opacity-95 pointer-events-none select-none sm:w-[400px] lg:w-[943px]"
          />
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.18)_0%,rgba(0,0,0,0.06)_30%,rgba(0,0,0,0.46)_100%)]" />

          <div className="relative z-10 flex min-h-[180px] flex-col justify-between p-4 lg:p-8">
            <div className="flex items-start justify-between gap-3">
              <Badge tone="amber">Subscriber Watchlist</Badge>

              <div className="ml-auto flex flex-col items-end gap-2 lg:flex-row">
                <Link
                  href="/"
            ...
            <div className="mt-auto rounded-2xl bg-black/18 px-4 py-3">
