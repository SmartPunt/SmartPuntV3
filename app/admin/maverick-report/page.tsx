    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(251,191,36,0.15),transparent_25%),linear-gradient(180deg,#0a0a0a_0%,#18181b_50%,#020617_100%)] p-4 text-white lg:p-8">
      <div className="mx-auto max-w-7xl">
        <div className="rounded-[30px] border border-white/10 bg-black/70 p-5 shadow-2xl backdrop-blur-sm lg:p-8">
          <div className="relative overflow-hidden rounded-[26px] border border-amber-300/25 bg-[radial-gradient(circle_at_top_left,rgba(251,191,36,0.22),transparent_38%),linear-gradient(135deg,rgba(39,39,42,0.98),rgba(9,9,11,0.98))] px-5 py-7 shadow-[0_24px_70px_rgba(0,0,0,0.45)] lg:px-8 lg:py-9">
            ...
            <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
                ...
                <div className="text-center sm:text-left">
                  <div className="flex flex-wrap items-center justify-center gap-2 sm:justify-start">
                    <span className="rounded-full border border-amber-300/30 bg-amber-300/10 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.22em] text-amber-200">
                  ...
                  <p className="mt-4 text-xs font-bold uppercase tracking-[0.3em] text-amber-300">
                    SmartPunt presents
                  </p>
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-300">
                    Every published selection, every official result and
                    complete performance transparency using the odds
                    recorded when each tip was released.
                  </p>
                </div>
              </div>
              ...
              <Link
                href="/"
                className="self-center rounded-2xl border border-amber-300/25 bg-black/30 px-5 py-3 text-sm font-semibold text-amber-100 transition hover:border-amber-300/50 hover:bg-amber-300/10 lg:self-start"
              >
                Back to Admin
              </Link>
            </div>
