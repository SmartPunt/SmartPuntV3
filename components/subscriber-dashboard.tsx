  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(251,191,36,0.10),transparent_20%),linear-gradient(180deg,#111315_0%,#18181b_50%,#0f172a_100%)] text-white">
      <div className="mx-auto max-w-7xl px-4 py-6 lg:px-8 lg:py-8">
        <div className="overflow-hidden rounded-[32px] border border-[#D4AF37]/20 bg-[linear-gradient(135deg,#121316_0%,#181920_55%,#23201a_100%)] p-6 shadow-xl lg:p-8 relative">
          <div className="pointer-events-none absolute inset-y-0 right-0 w-[38%] bg-[radial-gradient(circle_at_center,rgba(212,175,55,0.16),transparent_70%)]" />
