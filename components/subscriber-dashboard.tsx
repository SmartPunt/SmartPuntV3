  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        {tip.race_start_at ? (
          <Badge tone="slate">{formatRaceTime(tip.race_start_at)}</Badge>
        ) : null}
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0F] text-white">
      <div className="mx-auto max-w-7xl px-4 py-6">
        ...
        {/* HEADER */}
        <div className="rounded-[32px] bg-gradient-to-r from-[#111118] to-[#1a1a22] p-8 border border-[#D4AF37]/20">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="flex flex-col items-start">
              ...
              <img
                src="/header-logo.png"
                alt="Fortune on 5"
                className="mb-6 w-full max-w-[520px] h-auto object-contain"
              />

              <div className="flex gap-2 mb-3">
                <Badge tone="amber">Premium Access</Badge>
            ...
            <div className="flex gap-3">
              <Link href="/my-resulted-tips">
                <button className="rounded-2xl border border-white/10 px-4 py-2 text-sm">
                  My Resulted Tips
                </button>
              </Link>
