    ...
    <Link
      ...
      className={`block rounded-2xl border px-4 py-3 text-sm font-semibold transition ${
        tone === "primary"
          ...
          : "border-white/10 bg-black text-white hover:bg-zinc-900"
      }`}
    >
      {label}
    </Link>
      ...
      <div className="mx-auto max-w-7xl p-4 lg:p-8">
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-[280px_minmax(0,1fr)]">
          <div className="space-y-6">
            <Panel className="sticky top-4 bg-white/95">
              <div className="p-5 text-zinc-950">
                <div className="flex items-center justify-between gap-3">
                  <h2 className="text-lg font-semibold">Admin tools</h2>
                  <Badge tone="amber">Quick nav</Badge>
                </div>
                ...
                <div className="mt-4 space-y-3">
                  ...
                  <ToolLink href="/admin/fortune-on-5" label="Fortune on 5" tone="primary" />
                  <ToolLink href="/admin/jockeys" label="Jockey Profiles" />
                </div>
              </div>
            </Panel>
          </div>
