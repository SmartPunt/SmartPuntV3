            ...
            <form action={formAction} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-2xl border border-amber-300/20 bg-black/30 px-4 py-2.5 text-white outline-none transition focus:border-amber-300"
                />
              </div>
              ...
              {state?.error ? (
                <div className="rounded-2xl bg-red-50 px-4 py-2.5 text-sm text-red-700">
                  {state.error}
                </div>
              ) : null}
