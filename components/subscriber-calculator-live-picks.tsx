...
<div className="relative overflow-hidden rounded-[22px] border border-emerald-300/60 bg-[linear-gradient(135deg,#050505_0%,#07100c_54%,#030504_100%)] p-4 shadow-[0_0_0_1px_rgba(52,211,153,0.08)_inset,0_0_22px_rgba(16,185,129,0.12),0_14px_35px_rgba(0,0,0,0.45)]">
  ...
  <img
    ...
    alt=""
    aria-hidden="true"
className="pointer-events-none absolute left-0 top-2 z-0 w-[260px] max-w-none select-none opacity-90 sm:w-[285px]"
  />
  ...
  <img
    ...
    alt=""
    aria-hidden="true"
className="pointer-events-none absolute -bottom-3 -right-4 z-0 w-[285px] max-w-none select-none opacity-68 sm:w-[315px]"
  />
